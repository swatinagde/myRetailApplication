...
* Technology Stack:
Springboot
RestTemplate : To call external API
Mockito/Junit : Unit test cases
...
* Read the API documentation in Swagger2 (run http://localhost:8000/swagger-ui.html on the browser)
